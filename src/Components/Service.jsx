  ...
  return (
    <div className="flex flex-col my-10 justify-center items-center">
      ...
      <p className="text-md text-center font-medium text-black">
        We provide expert legal advice and representation across a wide range of
        practice areas. Our services include civil, criminal, corporate, family,
        and property law. From legal consultation to courtroom advocacy - we
        stand by your side at every step.
      </p>
